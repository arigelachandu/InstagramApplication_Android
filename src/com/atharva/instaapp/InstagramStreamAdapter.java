...
public class InstagramStreamAdapter extends BaseAdapter {
	private HashMap<ImageView, DownloadBitmap> competitors;

	JSONObject imageData;
	Context c;
	int size = 0;

	public InstagramStreamAdapter(Context c, JSONObject imageData, int number) {
		Log.i("crb", "image data downloaded");
		this.c = c;
		this.imageData = imageData;
		competitors = new HashMap<ImageView, DownloadBitmap>();
		//ImageView n= new ImageView(get)
		size = number;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		try {
			...
			DownloadBitmap other = competitors.put(imageView, task);
